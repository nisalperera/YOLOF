...
_C.LOGGER = CN()
_C.LOGGER.WANDB = CN()
_C.LOGGER.WANDB.ENABLED = True
_C.LOGGER.WANDB.NAME = "L1"
_C.LOGGER.WANDB.NOTES = "L1: Fine-tuning YOLOF R-50 DC5 for thesis experiments. Reference Model."
_C.LOGGER.WANDB.PROJECT = "Thesis"